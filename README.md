...
\`\`\`{ r, echo = FALSE} knitr::opts\_chunk$set( collapse = TRUE, comment = "\#&gt;", fig.path = "tools/readme/" )
...
A package to automate and summarise ranking trends for species or groups of species. Ranking systems will be initially focused on NatureServe with expansion to other international standards.
